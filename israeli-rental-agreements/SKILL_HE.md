...
- חוק שכירות הוגנת 2017 חל רק על שכירות למגורים. סוכנים עלולים להחיל בטעות את הוראותיו (תקרת פיקדון, תקני מגורים) על שכירות מסחרית, שם חלים כללים שונים.
...
- הצמדה למדד המחירים לצרכן הישראלי יכולה ללכת גם למעלה וגם למטה. סוכנים עלולים להניח ששכירות רק עולה, ולפספס שתקופות דפלציה בפועל מפחיתות את השכירות המוצמדת.
- תקרת הסמכות של בית משפט לתביעות קטנות (כיום 38,900 ש"ח) משתנה מעת לעת. סוכנים שמייעצים בסכסוכי פיקדון או תביעות שכירות חייבים לוודא את הסף העדכני ולא להסתמך על נתוני אימון.
- שטר הון ניתן לאכיפה דרך ההוצאה לפועל ללא דיון מלא בבית משפט, מה שהופך אותו למסוכן הרבה יותר לשוכרים מאשר ערבות בנקאית. סוכנים שלא מכירים את כלי הערבות הישראליים עלולים להתייחס לכל סוגי הפיקדונות כשווים.
